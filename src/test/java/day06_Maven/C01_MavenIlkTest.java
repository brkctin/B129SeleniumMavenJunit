...
public class C01_MavenIlkTest {
    public static void main(String[] args) {
        ...
        System.out.println("Bulunan Sonuc Sayısı = "+sonuc[2]);



        //Bulunan sonuc sayisini LAMBDA ile yazdiralim..
        //1-16 of 223 results for "Samsung headphones"
        Arrays.stream(sonucSayisi.getText().split(" ")).skip(2).limit(1).forEach(t-> System.out.println("Sonuc Sayısı" + t));
